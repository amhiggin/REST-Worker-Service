...
def calculate_average(self, total_complexity, num_files_assessed):
    return (total_complexity / num_files_assessed)
...
def get_results(num_workers, start_time, end_time):
